...
var UsuarioHttpService = /** @class */ (function () {
    function UsuarioHttpService(http) {
        this.http = http;
        this.base_path = 'http://186.219.4.245:8080/usuario';
        this.httpOptions = {
    ...
    UsuarioHttpService.prototype.efetuarCadastro = function (postData) {
        return this.http.
            post(this.base_path + '/cadastro', postData, this.httpOptions)
            .pipe();
    };
    UsuarioHttpService.prototype.efetuarLogin = function (postData) {
        return this.http.post(this.base_path + '/login', postData, this.httpOptions)
            .pipe();
    };
