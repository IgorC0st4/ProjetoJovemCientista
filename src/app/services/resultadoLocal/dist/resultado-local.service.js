...
exports.ResultadoList = exports.ResultadoLocalService = void 0;
var core_1 = require("@angular/core");
var ResultadoLocalService = /** @class */ (function () {
    function ResultadoLocalService(storage) {
    ...
    ResultadoLocalService.prototype.get = function (numeroNivel) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.storage.get(this.key + '-' + numeroNivel)];
            });
        });
    };
    ResultadoLocalService.prototype.inicializarResultados = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    ResultadoLocalService.prototype.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                resultados = [];
                return [2 /*return*/, this.storage.forEach(function (value, key, iterationNumber) {
                        var resultado = new ResultadoList();
                        resultado.key = key;
    ...
    ResultadoLocalService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
...
exports.ResultadoLocalService = ResultadoLocalService;
var ResultadoList = /** @class */ (function () {
    function ResultadoList() {
    }
    return ResultadoList;
}());
exports.ResultadoList = ResultadoList;
